...
@section('body')
<section id="menu" class="d-flex justify-content-center align-items-center mt-5 pb-5" style="height:100vh;">
    <div class="container">
        <div class="row justify-content-sm-center gy-2">
            <div class="col-12 col-md-6 col-lg-4 mb-2 me-lg-1 mb-md-3 mb-lg-0">
                <div class="card pilihan d-flex">
                    <div class="card-body text-center">
                        <i class="bi bi-person-gear fw-bold"></i>
                        <h3 class="card-text fw-bold translate">
                            <a href="manageAkun.php" class="link">Manage Account</a>
                        </h3>
                    </div>
                </div>
            </div>
